    ...
    if (submitted) {
        return (
            <div className="modal-overlay" style={{ display: 'flex' }} onClick={onClose}>
                <div className="modal-wrapper" onClick={e => e.stopPropagation()} style={{ textAlign: 'center', padding: '3rem' }}>
    ...
    return (
        <div className="modal-overlay" style={{ display: 'flex' }} onClick={onClose}>
            <div className="modal-wrapper" onClick={e => e.stopPropagation()}>
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexGroup: 'column', gap: '1.5rem', flexDirection: 'column' }}>
